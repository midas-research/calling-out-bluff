...
class EssaySet(object):
    ...
    def add_essay(self, essay_text, essay_score, essay_generated=0):
        ...
        if isinstance(essay_score, int) and isinstance(essay_text, basestring)\
            ...
            #print("CT", self._clean_text)
            #print("CT2", self._clean_text[0])
            #print("CT3", self._clean_text[1])

            self._pos.append(nltk.pos_tag(self._clean_text[0]))
            #print(len(self._pos), self._pos)
