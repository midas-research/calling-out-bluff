...
percentage_list = ['five', 'ten', 'fifteen', 'twenty']
for percentage in percentage_list:
    files = os.listdir("percent/"+percentage+"/p8/")
    print(files)
    print(len(files))
    ...
    #     apple = lkewflkqfnqf
        xgboost_adv_file_path = "feature_files/"+percentage+"/prompt8/asap_xgboost_"+testcases_name+".npz"
    #     xgboost_adv_file_path = "feature_files/prompt1/asap_xgboost_new.npz"
        adv_file = "percent/"+percentage+"/p8/"+testcases
...
#         print(test_features_adv)
    ...
    #     print("pred_scores", pred_scores)
        ...
        file = open("predictions/"+percentage+"/prompt8/"+testcases_name+"_upscaled.csv", 'w+', newline ='') 
