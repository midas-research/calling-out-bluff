...
testcases_path = 'AES_FinalTestcases/prompt2/'
...
# te
testcases_files.remove("babel_prompt2.csv")
testcases_files.remove("test1.csv")
testcases_files.remove("svo_triplets_all_prompt2.csv")
testcases_files.remove("svo_triplets_random_prompt2.csv")
...
#                 print("essay", essay)
    ...
    saver = tf.train.import_meta_graph("runs/essay_set_2_cv_1_Jun_04_2020_21:51:15/checkpoints-17100.meta")  
    with tf.Session() as sess:
        saver.restore(sess,"runs/essay_set_2_cv_1_Jun_04_2020_21:51:15/checkpoints-17100")
...
#         stat_df.to_csv('predicted_scores/prompt1/stats_'+testcase, index=None)
        pred_df.to_csv('predicted_scores/prompt2/pred_'+testcase, index=None)
