...
testcases_path = 'AES_FinalTestcases/prompt4/'
...
testcases_files = ["babel_prompt4.csv", "entities_beg_unbound_4.csv"]
# te
# testcases_files.remove("babel_prompt4.csv")
# testcases_files.remove("test3.csv")
# testcases_files.remove("svo_triplets_all_prompt4.csv")
# testcases_files.remove("svo_triplets_random_prompt4.csv")
...
#                 print("essay", essay)
    ...
    saver = tf.train.import_meta_graph("runs/essay_set_4_cv_1_Jun_04_2020_23:55:32/checkpoints-18330.meta")  
    with tf.Session() as sess:
        saver.restore(sess,"runs/essay_set_4_cv_1_Jun_04_2020_23:55:32/checkpoints-18330")
...
#         stat_df.to_csv('predicted_scores/prompt1/stats_'+testcase, index=None)
        pred_df.to_csv('babel/prompt4/pred_'+testcase, index=None)
