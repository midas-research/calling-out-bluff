...
testcases_path = 'AES_FinalTestcases/prompt6/'
...
testcases_files = ["babel_prompt6.csv", "entities_beg_unbound_6.csv"]
# te
# testcases_files.remove("babel_prompt6.csv")
# testcases_files.remove("test5.csv")
# testcases_files.remove("svo_triplets_all_prompt6.csv")
# testcases_files.remove("svo_triplets_random_prompt6.csv")
...
#         stat_df.to_csv('predicted_scores/prompt1/stats_'+testcase, index=None)
        pred_df.to_csv('babel/prompt6/pred_'+testcase, index=None)
