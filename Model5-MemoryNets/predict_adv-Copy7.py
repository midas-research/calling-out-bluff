...
testcases_path = 'AES_FinalTestcases/prompt7/'
...
testcases_files = ["babel_prompt7.csv", "entities_beg_unbound_7.csv"]
# te
# testcases_files.remove("babel_prompt7.csv")
# testcases_files.remove("test6.csv")
...
#         stat_df.to_csv('predicted_scores/prompt1/stats_'+testcase, index=None)
        pred_df.to_csv('babel/prompt7/pred_'+testcase, index=None)
