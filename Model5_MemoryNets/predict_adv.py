...
testcases_files = ["babel_prompt3.csv", "entities_beg_unbound_3.csv"]
# te
# testcases_files.remove("babel_prompt1.csv")
# testcases_files.remove("test8.csv")
# testcases_files.remove("svo_triplets_all_prompt1.csv")
# testcases_files.remove("svo_triplets_random_prompt1.csv")
...
#         stat_df.to_csv('predicted_scores/prompt1/stats_'+testcase, index=None)
        pred_df.to_csv('babel/prompt3/pred_'+testcase, index=None)
