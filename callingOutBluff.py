...
for model_id in args.models:
    if model_id == 1:
        ...
        subprocess.run(['/home/rajivratn/anaconda3/envs/att_SAS/bin/python3.6', 'nea_predict_scores_singleCommand.py', args.prompt_id, args.path_to_original_file, args.path_to_adversarial_testfile])
    ...
    if model_id == 3:
        subprocess.run(['/home/rajivratn/anaconda3/envs/skipflow/bin/python3.6', 'skipflow_predict_scores_singleCommand.py', args.prompt_id, args.path_to_original_file, args.path_to_adversarial_testfile])
        print("DONE, FILE SAVED")
        print("#############################################################################")
    ...
    if model_id == 4:
        ...
        subprocess.run(['/home/rajivratn/anaconda3/envs/meharpy3/bin/python3.6', 'bertTwoStage_predict_scores_singleCommand.py', args.prompt_id, args.path_to_original_file, args.path_to_adversarial_testfile])
        print("DONE, FILE SAVED")
        print("#############################################################################")
        
    if model_id == 5:
        print("Selected model 5-> Memory Networks")
        subprocess.run(['/home/rajivratn/anaconda3/envs/meharpy3/bin/python3.6', 'memoryNets_predict_scores_singleCommand.py', args.prompt_id, args.path_to_original_file, args.path_to_adversarial_testfile])
        print("DONE, FILE SAVED")
        print("#############################################################################")