...
def init(essay_type): 
	...
	return model, graph, glove_emb, tokenizer, range_min, range_max

model, graph, glove_emb, tokenizer, range_min, range_max = init(str(prompt_id))
